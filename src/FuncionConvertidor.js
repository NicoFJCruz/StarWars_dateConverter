export function Convertidor(inputValue, selectedOption) {
  const conversionMap = {
    Yavin: { Yavin: 0, Lothal: 3277, Convenio: -36, Hosnian: 7977, Sith: -35, Naboo: 867, Imperio: -19 },
    ...
    Imperio: { Yavin: 19, Convenio: -54, Sith: -53, Naboo: 885, Lothal: 3295, Hosnian: 7995, Imperio: 0 }
  };
